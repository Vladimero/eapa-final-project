...
export default async function NavBarForm() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-30 mx-auto w-full max-w-screen-xl border border-gray-100 bg-white/80 py-4 md:py-6 shadow backdrop-blur-lg md:top-6 md:rounded-3xl">
      <div className="px-4">
