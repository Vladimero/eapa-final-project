...
import LandingPageIconOne from '../public/images/LandingPageIconOne.jpg';
import LandingPageIconTwo from '../public/images/LandingPageIconTwo.jpg';
...
export default async function Home() {
  ...
  return (
    <div
      className="leading-normal tracking-normal text-black gradient"
      style={bodyBgStyle}
    >
      <div className="pt-24">
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            <h1 className="my-4 text-5xl font-bold leading-tight">
              Environmental Assessment Platform of Austria
            </h1>
            <p className="leading-normal text-2xl mb-8">
              Transforming Environmental Insights into Action for Austria's
              Future
            </p>
            {user ? (
              <Link
          ...
          <div className="flex flex-wrap">
            <div className="w-5/6 sm:w-1/2 p-6">
              ...
              <p className="text-gray-600 mb-8">
                Delve into inspiring success stories detailing the positive
                impact of conservation efforts across Austria's diverse
                ecosystems. From urban areas to rural landscapes, see the
          ...
          <div className="flex flex-wrap flex-col-reverse sm:flex-row">
            ...
            <div className="w-full sm:w-1/2 p-6 mt-6">
              <div className="align-middle">
                ...
                <p className="text-gray-600 mb-8">
                  Explore compelling statistics showcasing Austria's progress in
                  reducing pollution, preserving natural habitats, and fostering
                  sustainable living.
                  <br />
                  <br />
                </p>
            ...
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              <div className="flex flex-wrap no-underline hover:no-underline">
                ...
                <p className="text-gray-800 text-base px-6 mb-5">
                  No matter where you encountered a pollution of any kinds, just
                  create an report, put your images there and place the address!
                </p>
              </div>
            </div>
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                <br />
                <p className="text-gray-800 text-base px-6 mb-5">
                  One of our governmental advisors is monitoring and reviewing
                  your report. Be prepared of being reached out by one of them
                  soon!
                </p>
              </div>
            </div>
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                <br />
                <p className="text-gray-800 text-base px-6 mb-5">
                  After an detailed investigation of your report the
                  governmental advisor is commissioning a company to remedy the
                  contamination!
                </p>
              </div>
            </div>
