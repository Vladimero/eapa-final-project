            ...
            <div className="flex flex-wrap flex-col-reverse sm:flex-row">
              ...
              <div className="w-full sm:w-1/2 p-6 mt-6">
                <div className="align-middle">
                  ...
                  <p className="text-gray-600 mb-8">
                    Explore compelling statistics showcasing Austria's progress
                    in reducing pollution, preserving natural habitats, and
              ...
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                <div className="flex flex-wrap no-underline hover:no-underline">
                  ...
                  <p className="text-gray-800 text-base px-6 mb-5">
                    No matter where you encountered a pollution of any kinds,
                    just create an report, put your images there and place the
                    address!
                  </p>
                </div>
              </div>
              ...
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                  ...
                  <p className="text-gray-800 text-base px-6 mb-5">
                    ...
                    governmental advisor is commissioning a company to remedy
                    the contamination!
                  </p>
                </div>
              </div>
